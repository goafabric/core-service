...
public class MedicalRecordDetailsView extends Dialog {
    ...
    private void addSaveButton(MedicalRecord medicalRecord, VerticalLayout layout) {
        ...
        buttonSave.addClickListener(event -> {
                var changedRecord = new MedicalRecord(medicalRecord.id(), medicalRecord.version(), medicalRecord.encounterId(), medicalRecord.type(), displayTextField.getValue(), medicalRecord.code(), medicalRecord.relation());
