...
public class MRCMainView extends VerticalLayout {
    ...
    public MRCMainView(
            PatientAdapter patientAdapter, MedicalRecordComponent medicalRecordComponent, BruteChatBot chatBot) {
        this.setSizeFull();

        TabSheet tabSheet = new TabSheet();
        tabSheet.setSizeFull();

        tabSheet.add("MRC", new MedicalRecordView(patientAdapter, medicalRecordComponent, chatBot));
