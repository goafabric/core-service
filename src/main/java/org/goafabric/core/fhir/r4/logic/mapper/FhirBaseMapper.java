...
public interface FhirBaseMapper {
    ...
    org.goafabric.core.data.controller.vo.Address map(org.goafabric.core.fhir.r4.controller.vo.Address value);

    @Mapping(expression = "java(java.util.Collections.singletonList(value.street()))", target = "line")
    org.goafabric.core.fhir.r4.controller.vo.Address map(org.goafabric.core.data.controller.vo.Address value);
}
