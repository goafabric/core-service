...
public interface FhirPatientMapper extends FhirBaseMapper {
    ...
    org.goafabric.core.organization.controller.vo.Patient map(org.goafabric.core.fhir.r4.controller.vo.Patient value);
    ...
    org.goafabric.core.fhir.r4.controller.vo.Patient map(org.goafabric.core.organization.controller.vo.Patient value);

    @Mapping(source = "contactPoint", target = "telecom")
    List<org.goafabric.core.fhir.r4.controller.vo.Patient> map(List<org.goafabric.core.organization.controller.vo.Patient> value);

    default List<HumanName> mapHumanName(org.goafabric.core.organization.controller.vo.Patient value) {
