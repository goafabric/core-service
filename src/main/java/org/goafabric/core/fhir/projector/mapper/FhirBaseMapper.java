...
public interface FhirBaseMapper {
    ...
    org.goafabric.core.data.controller.vo.Address map(org.goafabric.core.fhir.projector.vo.Address value);

    @Mapping(expression = "java(java.util.Collections.singletonList(value.street()))", target = "line")
    org.goafabric.core.fhir.projector.vo.Address map(org.goafabric.core.data.controller.vo.Address value);
}
